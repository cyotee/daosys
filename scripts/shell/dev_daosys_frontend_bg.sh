...
# Resolve daosys repo root from this script location.
DAOSYS_ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/../.." && pwd)"
FRONTEND_DIR="$DAOSYS_ROOT/lib/daosys_frontend"

# Logs/PIDs go into ./tmp of *where you run this script from*.
ROOT_PWD="$(pwd -P)"
